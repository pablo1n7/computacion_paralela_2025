...
def main(procesos, individuos=10, posiciones=4, numero_de_repeticiones=10, resultado='resultados/resultado.txt'):
...
if __name__ == "__main__":
    ...
    resultado_tiempos.to_csv('resultados/tiempos.csv', index=False)
    print('Listo.')
# %%
